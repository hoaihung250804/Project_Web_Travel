...
function book() {
    var _a, _b;
    const gatheringLocation = (_a = document.getElementById("tour-gathering_location")) === null || _a === void 0 ? void 0 : _a.textContent;
    const gatheringTime = (_b = document.getElementById("tour-gathering_time")) === null || _b === void 0 ? void 0 : _b.textContent;
...
function displayTourDetails() {
    ...
    fetch("/travel_VN/javascript/data.json")
        ...
        if (tour) {
            const nameElement = document.getElementById("tour-name");
            ...
            const shortDescriptionElement = document.getElementById("tour-short_description");
            const gatheringLocationElement = document.getElementById("tour-gathering_location");
            const gatheringTimeElement = document.getElementById("tour-gathering_time");
            const imagesContainer = document.getElementById("tour-images"); // Phần chứa ảnh đầu tiên
